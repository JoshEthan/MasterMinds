...
import sched
import time
# THE BOT: NEEDS TO PULL DATA FROM MARKET TOTAL PERCENTAGE THING AND CHECK IT.
...
rh = Robinhood()
rh.login(username="joshuaeris@gmail.com",
         password="myfun4meto", challenge_type='sms')
